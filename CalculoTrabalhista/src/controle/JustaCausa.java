...
public class JustaCausa extends Calculo {
...
public void escreverCalculo(String texto,String nome) {
	String caminhoCalculo = "C:\\CalculoTrabalhista\\Calculos\\Justa Causa\\calculo.txt";
	caminhoCalculo = caminhoCalculo.substring(0, caminhoCalculo.length() - 11) + nome.trim() + " JustaCausa" + ".txt";
	try {
