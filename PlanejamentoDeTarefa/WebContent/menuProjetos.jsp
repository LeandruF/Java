...
<input type="submit" id="logout "value="" style=" margin-top:10px;float: right; background: url('imagens/logo2.png') 80px 20px  no-repeat; height: 120px;border: 0px; box-shadow: unset;" formaction="ServletLogout" formmethod="post"/>
		...
		<main id="main">
			<div style="text-align: center; margin-left: 5%;">
				...
				<fieldset style="display: block; width: 90%; margin-top: 30px; margin-left: 1px; background-color: #d3ffff; border-radius: 20pt;">
					<legend style="font: normal 20pt Courgette; background-color: #d3ffff; color: #15224b; padding: 5px 5px;">MENU TAREFA </legend>
						<form name="formProjeto" id="formProjeto" action="" method = "" >
						<input type="submit" value="Cadastrar Projeto " formaction="projetos.jsp" formmethod="post" style="width: 95%; "/>
						<input type="submit" value="Alterar Projeto " formaction="ServletListarUpdateProjeto" formmethod="post" style="width: 95%;"/>
						<input type="submit" value="Localizar Projeto " formaction="ServletLocalizarProjeto" formmethod="post" style="width: 95%;"/>
						<input type="submit" value="Deletar Projeto " formaction="ServletDeletarProjeto" formmethod="post" style="width: 95%;"/>
						</form>
